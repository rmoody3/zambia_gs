...
### Pre-processing
  ...
  The mask data required a bit of preprocessing.  First, the original TIFF data file was uploaded into the R environment, rasterized, and reprojected to the extent and resolution of the planting and harvesting data.  After this, the values of 0 within the crop_mask file were converted to NA values, finishing its preprocessing and readying it for use in analysis.
```{r, eval=FALSE}
