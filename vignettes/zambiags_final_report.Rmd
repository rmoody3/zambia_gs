...
To aggregate the mean planting and harvesting dates across districts, we rasterized and projected the Zambia district data from the Geospaar package. The mean planting and harvesting dates within each district were then calculated using the zonal statistics function. The tabular outputs of each zonal function were then respectively converted to data frames and converted back to spatial data through the subs function using the raster districts as the target layer.
```{r, eval = FALSE}
...
plot(harv_mean_corrected, axes = FALSE, box = FALSE,
     add = TRUE, col = rev(terrain.colors(10)))
```
![Figure 1: This image shows the mean planting and harvesting dates in Zambia between 2000 and 2018.](C:/Users/Rowan/Documents/R/zambiags/images/datemeans.png)
...
plot(distr_hamu, main = "Mean Harvesting Date",
     axes = FALSE, box = FALSE, col = rev(terrain.colors(10)))
```
![Figure 2: This image shows the mean planting and harvesting dates for each district in Zambia between 2000 and 2018.](C:/Users/Rowan/Documents/R/zambiags/images/distr_datemeans.png)
...
```
![Figure 3: This image shows the mean season length in Zambia between 2000 and 2018.](C:/Users/Rowan/Documents/R/zambiags/images/slength_pixel.png)

```{r, eval = FALSE}
plot(distr_slmu, main = "Mean Season Length",
     axes = FALSE, box = FALSE, col = rev(terrain.colors(10)))
```
![Figure 4: This image shows the mean season length for each district in Zambia between 2000 and 2018.](C:/Users/Rowan/Documents/R/zambiags/images/slength_dist.png)
