...
The folder contains estimated Zambia planting date in Date of Year (DOY) format in 17 growing seasons: 2000/2001 to 2017/2018.
...
Note: crop mask was not applied, so only a few of pixels in this map indicating real planting date.  
Therefore, in order to do meaningful analysis, you need to apply crop mask.
...
1) The planting date is defined as the time at 30% green up of the NDVI curve for a given phenology curve.  In other words, each growing season has one up and down in the NDVI curve, and the peak NDVI is defined as 100%. As time goes, the NDVI will climb from 0% at the left-end (minimum) of the curve. The planting date is at 30% up to the peak.  See Urban, D., Guan, K., & Jain, M. (2018). Estimating sowing dates from satellite data over the US Midwest: a comparison of multiple sensors and metrics. Remote sensing of environment, 211, 400-412.
